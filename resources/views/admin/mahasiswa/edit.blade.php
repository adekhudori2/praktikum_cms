...
<body>
            ...
            <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nim" name="nim" class="form-input" 
                           value="{{ old('nim', $mahasiswa->nim) }}" required maxlength="10">
                    @error('nim')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="alamat" name="alamat" class="form-textarea" required>{{ old('alamat', $mahasiswa->alamat) }}</textarea>
                    @error('alamat')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    @if($mahasiswa->foto)
                        <div class="current-photo">
                            <p style="margin-bottom: 0.5rem; color: #6b7280;">Foto saat ini:</p>
                    ...
                    <label for="foto" class="file-label">
                        ...
                        <span id="file-name">{{ $mahasiswa->foto ? 'Ganti foto (JPG, PNG, JPEG - Max 2MB)' : 'Pilih file foto (JPG, PNG, JPEG - Max 2MB)' }}</span>
                    </label>
                    @error('foto')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
    ...
    <script>
        ...
        document.getElementById('foto').addEventListener('change', function(e) {
            const fileName = e.target.files[0] ? e.target.files[0].name : '{{ $mahasiswa->foto ? "Ganti foto (JPG, PNG, JPEG - Max 2MB)" : "Pilih file foto (JPG, PNG, JPEG - Max 2MB)" }}';
